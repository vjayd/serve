...
# -*- coding: utf-8 -*-
"""
Created on Sat Mar 23 18:57:46 2019
...
def makecopies(f, version, timestampattached):
    res1 = requests.post(BASE_URL_S1 + 'uploader',files={'file': open(f, 'rb')}, data ={'version':version,'timestamp': timestampattached})  
...
def upload_file():
   if request.method == 'POST':
      ...
      if (var):
          ...
          res1, res2 = makecopies(filename, version, timestampattached)
          return jsonify({ 'file': filename , 'version': version, "var":var})
